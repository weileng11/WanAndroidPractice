package com.bruce.wanandroidmvvm_sx.app.network

import com.bruce.wanandroidmvvm_sx.App
import com.bruce.wanandroidmvvm_sx.app.NetApiService
...
//            addInterceptor(HeadInterceptor())
    ...
    override fun setRetrofitBuilder(builder: Retrofit.Builder): Retrofit.Builder {
        return builder.apply {
            ...
            addCallAdapterFactory(CoroutineCallAdapterFactory()) //没有使用rxjava
        }
    }
