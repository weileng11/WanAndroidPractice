package com.bruce.wanandroidmvvm_sx.ui.setting
...
import com.bruce.wanandroidmvvm_sx.app.AppViewModel
import com.bruce.wanandroidmvvm_sx.app.ext.getAppViewModel
...
import com.bruce.wanandroidmvvm_sx.app.weight.preference.CheckBoxPreference
import com.bruce.wanandroidmvvm_sx.app.weight.preference.IconPreference
import com.bruce.wanandroidmvvm_sx.app.weight.preference.PreferenceCategory
            ...
            activity?.let { activity ->
                MaterialDialog(activity).show {
                    ...
                    listItemsSingleChoice(
                        ...
                        it.summary = text
                        //通知其他界面立马修改配置
                        appViewModel.appAnimation.postValue(index)
                    }
                    title(text = "设置列表动画")
            ...
            activity?.let { activity ->
                MaterialDialog(activity).show {
                    ...
                    colorChooser(
                        ...
                        //通知其他界面立马修改配置
                        appViewModel.appColor.postValue(color)
                    }
                    getActionButton(WhichButton.POSITIVE).updateTextColor(
                        SettingUtil.getColor(
                            activity
        ...
        findPreference<Preference>("project")?.setOnPreferenceClickListener {
            ...
            view?.let {
                Navigation.findNavController(it)
                    .navigate(R.id.action_settingFragment_to_webFragment, Bundle()
