...
import com.bruce.wanandroidmvvm_sx.data.repository.LoginRepository
...
//        )
        ...
        requestNoCheck({loginRpository.login(username.get(),password.get())},loginResult2,true,"正在登录中...")
//
