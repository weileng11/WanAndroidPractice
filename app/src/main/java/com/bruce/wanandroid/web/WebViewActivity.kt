package com.bruce.wanandroid.web
...
import com.bruce.wanandroid.web.presenter.WebPresenter
import com.bruce.wanandroid.widget.WebDialogFragment
...
//        val clipData = ClipData.newPlainText("Label", "baidu")
        // 创建链接型 clipData
        var clipData = ClipData.newRawUri("Label", Uri.parse(loadUrl))
        // 将ClipData内容放到系统剪贴板里。
